...
class HeaderLayer:
    ...
    def __init__(self, data):
        ...
        self.cadversion = extract[0].strip()
        self.ekatte = extract[1].strip()
        self.loc = extract[2].strip()
        self.sw = extract[3].strip()
        self.swv = extract[4].strip()
        self.date = extract[5].strip()
        self.firm = extract[6].strip()
        self.refX, self.refY = float(extract[8].strip()), float(extract[7].strip())
        self.window = extract[9].strip()
        self.coordid = extract[10].strip()
        self.coordidh = extract[11].strip()
        self.content = extract[12].strip()
        self.comments = extract[13].strip()
